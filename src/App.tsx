...
import { Activity, BellRing, BookOpenCheck, BrainCircuit, ChartNoAxesCombined, CircleDollarSign, Gauge, History, LayoutDashboard, RefreshCw, ShieldCheck, Star, Target, WalletCards } from 'lucide-react';
...
const nav=[['市场总览',LayoutDashboard],['赚钱效应',CircleDollarSign],['板块生命周期',History],['核心股池',Target],['逆势强度',ShieldCheck],['资金迁移',ChartNoAxesCombined],['我的持仓',WalletCards],['我的自选',Star],['盘中预警',BellRing],['每日复盘',BookOpenCheck],['历史回测',Gauge],['月度候选',Activity],['AI分析',BrainCircuit]] as const;
